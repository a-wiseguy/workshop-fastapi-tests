...
class TestLevel1Exercises:
    ...
    def test_task_create_with_all_fields(self, sample_user):
        ...
        """
        sample_user_uuid = sample_user.uuid
        ...
        assert task.assigned_to == sample_user_uuid
